...
For any state functions $f$ of some variables $x$ and $y$, the second order derivative commutes (Schwarz theorem):
...
See for example the discussion of John C. Baez [of this topic](https://johncarlosbaez.wordpress.com/2012/01/19/classical-mechanics-versus-thermodynamics-part-1/).
...
- [John C. Baez - Classical Mechanics versus Thermodynamics (Part 1 to 4)](https://johncarlosbaez.wordpress.com/2012/01/19/classical-mechanics-versus-thermodynamics-part-1/)
