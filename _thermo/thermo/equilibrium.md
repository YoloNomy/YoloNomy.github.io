...
What is sometimes considered as the zeroth principle of thermodynamics states that thermal equilbrium is "contagious". 

That is: consider three systems $A$, $B$ and $C$. If $A$ is at thermal equilibrium with $B$ and $A$ is a thermal equilibrium with $C$, then $B$ is at thermal equilibrium with $C$.
